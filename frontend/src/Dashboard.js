...
export default class Dashboard extends Component {
  ...
  getProduct = () => {
    ...
    axios.get(`backend:2000/get-product${data}`, {
      headers: {
  ...
  deleteProduct = (id) => {
    axios.post('backend:2000/delete-product', {
      id: id
    }, {
      headers: {
  ...
  addProduct = () => {
    ...
    axios.post('backend:2000/add-product', file, {
      headers: {
  ...
  updateProduct = () => {
    ...
    axios.post('backend:2000/update-product', file, {
      headers: {
        'content-type': 'multipart/form-data',
        'token': this.state.token
      }
            ...
            <TableBody>
              {this.state.products.map((row) => (
                <TableRow key={row.name}>
                  ...
                  <TableCell align="center"><img src={`backend:2000/${row.image}`} width="70" height="70" /></TableCell>
